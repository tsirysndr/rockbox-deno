    ...
    fn call(&mut self, req: http::Request<B>) -> Self::Future {
      match req.uri().path() {
        ...
        "/rockbox.v1alpha1.LibraryService/Search" => {
          ...
          impl<T: LibraryService>
            tonic::server::UnaryService<super::SearchRequest> for SearchSvc<T>
          {
...
pub mod playback_service_client {
    ...
    <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
  {
    ...
    pub async fn resume(
      ...
      tonic::Response<super::ResumeResponse>,
      tonic::Status,
    > {
      self.inner.ready().await.map_err(|e| {
        tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
    ...
    pub async fn status(
      ...
      tonic::Response<super::StatusResponse>,
      tonic::Status,
    > {
      self.inner.ready().await.map_err(|e| {
        tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
    ...
    fn call(&mut self, req: http::Request<B>) -> Self::Future {
      match req.uri().path() {
        ...
        "/rockbox.v1alpha1.PlaybackService/Resume" => {
          ...
          impl<T: PlaybackService>
            tonic::server::UnaryService<super::ResumeRequest> for ResumeSvc<T>
          {
        ...
        "/rockbox.v1alpha1.PlaybackService/StreamCurrentTrack" => {
            ...
            > for StreamCurrentTrackSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut = async move {
                <T as PlaybackService>::stream_current_track(&inner, request)
                  .await
              };
              Box::pin(fut)
            }
...
pub mod playlist_service_client {
    ...
    <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
  {
    ...
    pub async fn amount(
      ...
      tonic::Response<super::AmountResponse>,
      tonic::Status,
    > {
      self.inner.ready().await.map_err(|e| {
        tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
    ...
    fn call(&mut self, req: http::Request<B>) -> Self::Future {
      match req.uri().path() {
        ...
        "/rockbox.v1alpha1.PlaylistService/Amount" => {
          ...
          impl<T: PlaylistService>
            tonic::server::UnaryService<super::AmountRequest> for AmountSvc<T>
          {
        ...
        "/rockbox.v1alpha1.PlaylistService/InsertArtistTracks" => {
            ...
            for InsertArtistTracksSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut = async move {
                <T as PlaylistService>::insert_artist_tracks(&inner, request)
                  .await
              };
              Box::pin(fut)
            }
